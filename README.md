# General Warning
## This is not at all complete. As of right now I have three of the seven different fixes done. This is going to change obviously but for now my program is not finished. Any setting changer past the first two, will either spit out a test message or crash the program.   
